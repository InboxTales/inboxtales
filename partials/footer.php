        ...
        <footer class="section-footer">
            <div class="bg-black">
                                    ...
                                    <button type="submit"
                                        ...
                                        <span
                                            class="absolute right-[5px] inline-flex h-[50px] w-[50px] items-center justify-center rounded-[50%] bg-black"><img
                                                ...
                                                alt="icon-buttery-white-arrow-right" width="34" height="28" /></span>
                                    </button>
                                </form>
                            </div>
                            <!-- Footer Right Block -->
                ...
                <div class="py-[35px]">
                    <!-- Section Container -->
                    <div class="container">
                        <div class="flex flex-wrap justify-center gap-x-[30px] gap-y-4 lg:justify-between items-center">
                            <a href="index.php" class="flex justify-center items-center">
                            ...
                            <div class="text-colorButteryWhite">
                                &copy; Copyright 2025, All Rights Reserved by InboxTales
                            </div>
                            <!-- Copyright Text -->
                        </div>
                    </div>
