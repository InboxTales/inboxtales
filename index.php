...
<main class="main-wrapper">
                        ...
                        <div class="text-center text-colorButteryWhite lg:text-start">
                            <h1>
                                Let’s Write <span class="inline-flex items-center gap-5"> Your Success Together.
                                    ...
                                    <!-- 
                                    <div
                                        class="mb-[50px] flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                                        <div class="flex -space-x-3">
                                            <img src="assets/img/images/th-1/hero-user-1.png" alt="hero-user-1"
                                                width="60" height="60"
                                                class="z-0 h-[66px] w-[66px] rounded-[50%] border-[6px] border-black" />
                                            <img src="assets/img/images/th-1/hero-user-2.png" alt="hero-user-2"
                                                width="60" height="60"
                                                class="z-[2] h-[66px] w-[66px] rounded-[50%] border-[6px] border-black" />
                                            <img src="assets/img/images/th-1/hero-user-3.png" alt="hero-user-3"
                                                width="60" height="60"
                                                class="z-[3] h-[66px] w-[66px] rounded-[50%] border-[6px] border-black" />
                                        </div>
                                        <span class="text-base font-semibold">Believed by more than a thousand
                                            people</span>
                                    </div> -->

                                    <a href="contact.php" class="btn-primary relative pr-20 md:pr-[118px]">Build Your
                                        Tale Now
                                        <span
                    ...
                    <ul class="grid grid-cols-1 gap-[30px] lg:grid-cols-3">
                        ...
                        <li class="jos group/team-item" data-jos_delay="0">
                            <div class="shadow-bg group h-full">
                                <div
                                    ...
                                    <img src="assets/img/icons/th-1-service-icon-1.svg" alt="th-1-service-icon-1"
                                        width="64" height="70" class="h-[70px] w-auto" />
                        ...
                        <li class="jos" data-jos_delay="0.3">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-2.svg" alt="th-1-service-icon-2"
                                        width="77" height="70" class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">App Development</h4>
                                    <p class="mb-7">
                                        We make user-friendly, custom apps designed to enhance engagement and deliver
                                        seamless experiences for your audience.
                                    </p>
                        ...
                        <li class="jos" data-jos_delay="0.6">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-3.svg" alt="th-1-service-icon-3"
                                        width="75" height="70" class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">Cyber Security</h4>
                                    <p class="mb-7">
                        ...
                        <li class="jos" data-jos_delay="0.9">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-4.svg" alt="th-1-service-icon-4"
                                        width="55" height="70" class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">Graphic Designing</h4>
                                    <p class="mb-7">
                                        We create impactful designs that represent your business identity and visually
                        ...
                        <li class="jos" data-jos_delay="1.2">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-5.svg" alt="th-1-service-icon-5"
                                        width="65" height="70" class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">Video Editing</h4>
                                    <p class="mb-7">
                                        Your brand's story comes to life with captivating, professionally edited videos
                        ...
                        <li class="jos" data-jos_delay="1.5">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-6.svg" alt="Lead Generating Icon"
                                        width="60" height="70" class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">Lead Generating</h4>
                                    <p class="mb-7">
                        ...
                        <!-- Service Item 7: Social Media Marketing -->
                        <li class="jos" data-jos_delay="1.8">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-7.svg"
                                        alt="Social Media Marketing Icon" width="62" height="70"
                                        class="h-[70px] w-auto" />
                                    <h4 class="mb-[15px] mt-[30px]">Social Media Marketing</h4>
                                    <p class="mb-7">
                        ...
                        <!-- Service Item 8: Digital Marketing -->
                        <li class="jos" data-jos_delay="2.1">
                            <div class="shadow-bg group h-full">
                                <div
                                    class="flex h-full flex-col items-start overflow-hidden rounded-[20px] border-2 border-black bg-colorIvory p-[30px] transition duration-300 group-hover:bg-colorLightLime">
                                    <img src="assets/img/icons/th-1-service-icon-8.svg" alt="Digital Marketing Icon"
                                        width="68" height="70" class="h-[70px] w-auto" />
                ...
                <div class="section-block mb-10 md:mb-[60px] xl:mb-20">
                    <div
                        ...
                        <p class="jos section-para">
                            We create strategies that combine marketing, design, and technology, helping businesses
                            grow, connect with audiences, and generate results.
                        </p>
                    </div>
                </div>
                <!-- Section Block -->
                        ...
                        <ul class="divide-y divide-[#333333]">
                            <li class="py-6 text-center first-of-type:pt-0 last-of-type:pb-0">
                                <div class="font-syne text-4xl font-bold leading-[1.07] -tracking-[1%] text-colorLightLime md:text-5xl xl:text-[70px]"
                                    data-module="countup">
                                    <span class="start-number" data-countup-number="2">2</span>+
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <img src="assets/img/images/th-1/project-img-1.jpg" alt="project-img-1" width="516"
                                        height="390"
                                    ...
                                    <div
                                        ...
                                        <a href="portfolio-details.php"
                                            ...
                                            <img src="assets/img/icons/icon-buttery-white-arrow-right.svg"
                                            ...
                                            <img src="assets/img/icons/icon-light-lime-arrow-right.svg"
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="group relative overflow-hidden rounded-[20px] border-[5px] border-colorButteryWhite">
                                    <img src="assets/img/images/th-1/project-img-2.jpg" alt="project-img-2" width="516"
                                        height="390"
                                        class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
    ...
    <div class="swiper-slide">
        <div class="group relative overflow-hidden rounded-[20px] border-[5px] border-colorButteryWhite">
            <img src="assets/img/images/th-1/project-img-3.jpg" alt="project-img-3" width="516" height="390"
                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
            ...
            <div
                ...
                <a href="portfolio-details.php" class="relative inline-flex items-start justify-center overflow-hidden">
                    <img src="assets/img/icons/icon-buttery-white-arrow-right.svg" alt="icon-buttery-white-arrow-right"
                        width="34" height="28"
                        class="translate-x-0 opacity-100 transition-all duration-300 group-hover:translate-x-full group-hover:opacity-0" />
                    <img src="assets/img/icons/icon-light-lime-arrow-right.svg" alt="light-lime-arrow-right" width="34"
                        height="28"
                        class="absolute -translate-x-full opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100" />
                </a>
            </div>
    ...
    <div class="swiper-slide">
        <div class="group relative overflow-hidden rounded-[20px] border-[5px] border-colorButteryWhite">
            <img src="assets/img/images/th-1/project-img-4.jpg" alt="project-img-4" width="516" height="390"
                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
    ...
    <div class="swiper-slide">
        <div class="group relative overflow-hidden rounded-[20px] border-[5px] border-colorButteryWhite">
            <img src="assets/img/images/th-1/project-img-1.jpg" alt="project-img-1" width="516" height="390"
                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
    ...
    <div class="swiper-slide">
        <div class="group relative overflow-hidden rounded-[20px] border-[5px] border-colorButteryWhite">
            <img src="assets/img/images/th-1/project-img-2.jpg" alt="project-img-2" width="516" height="390"
                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
    ...
    <div
        ...
        <div
            ...
            <img src="assets/img/icons/icon-black-arrow-right.svg" alt="icon-black-arrow-right" width="34"
                height="28" />
        </div>
    </div>
    </div>
                ...
                <div
                    ...
                    <div class="section-block text-center lg:text-start">
                        ...
                        <div class="jos mt-6">
                            <p class="section-para">
                                At Inbox Tales, we follow a streamlined process that ensures efficiency, creativity, and
                                successful outcomes for each project. Here's how we work:
                            </p>

                            <p class="section-para">
                                Whether it's designing a website, developing a custom app, ensuring your cybersecurity,
                                or boosting your digital presence, we work closely with you to deliver tailored
                        ...
                        <div class="jos mt-6">
                            <a href="contact.php" class="btn-primary relative  md:pr-[18px]">Build Your
                                Tale Now
                    ...
                    <ul class="jos flex flex-col gap-y-6">
                        ...
                        <li class="accordion-item-style-1 accordion-item active">
                            ...
                            <div
                                ...
                                <div class="accordion-icon">
                                    <img src="assets/img/icons/icon-black-arrow-less-down.svg"
                            ...
                            <div class="accordion-body max-w-[826px] opacity-80">
                                <p class="pt-5">
                                    We begin by understanding your vision, goals, and challenges. Our team collaborates
                                    closely with you to define the scope, objectives, and design the best approach for
                                    your project.
                                </p>
                            </div>
                            <!-- Accordion Body -->
                        ...
                        <li class="accordion-item-style-1 accordion-item">
                            ...
                            <div class="accordion-body max-w-[826px] opacity-80">
                                <p class="pt-5">
                                    With a clear roadmap, we move into designing and developing your digital solution.
                                    From web design and app development to creating effective digital marketing
                                    strategies, we ensure your needs are met with the latest technologies.
                                </p>
                            </div>
                            <!-- Accordion Body -->
                        </li>
                        ...
                        <li class="accordion-item-style-1 accordion-item">
                            ...
                            <div class="accordion-body max-w-[826px] opacity-80">
                                <p class="pt-5">
                                    Once your project is launched, we continuously monitor, optimize, and ensure
                                    security. Whether it's through ongoing digital marketing, app updates, or
                                    cybersecurity checks, we provide ongoing support for sustained success.
                                </p>
                            </div>
                            <!-- Accordion Body -->
                        </li>
        ...
        <div class="bg-black py-5">
            <div class="horizontal-slide-from-right-to-left flex items-center gap-x-6">
                ...
                <div class="h-10 min-w-[42px]">
                    <img src="assets/img/elemnts/shape-light-lime-5-arms-star.svg" alt="shape-light-lime-5-arms-star"
                        width="74" height="70" class="h-10 w-auto" />
                </div>
                <!-- Text Slider Item Text -->
                <div
                    class="whitespace-nowrap font-syne text-[35px] font-bold leading-none tracking-[1px] text-colorLightLime">
                ...
                <ul class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    ...
                    <li class="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
                        ...
                        <div class="mt-5 text-center">
                            <a href="team-details.php" class="display-heading display-heading-4 mb-4 block">

                                Snehith Chowdary
                            </a>
                            <span class="text-lg md:text-[21px]">Founder</span>
                        </div>
                    </li>
                    ...
                    <li class="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
                        ...
                        <div class="mt-5 text-center">
                            <a href="team-details.php" class="display-heading display-heading-4 mb-4 block">
                                Sri Ram</a>
                            <span class="text-lg md:text-[21px]">Co- Founder</span>
                        </div>
                    </li>
                    ...
                    <li class="jos group/team-item" data-jos_delay="0" data-jos_animation="flip-left">
                        <div class="relative overflow-hidden rounded-[20px] border-[5px] border-black">
                            <img src="./assets/img/madhav.webp" alt="Madav Reddy" width="296"
                                style="height:450px; object-position:50% 10%;" loading="lazy"
                                class="h-full w-full object-cover transition-all duration-300 group-hover/team-item:scale-110" />
                            <div
                                class="absolute top-full flex w-full justify-center gap-3 transition-all duration-300 group-hover/team-item:-translate-y-14">
