    ...
    <div class="section-space">
        ...
        <div class="container">
            ...
            <article>
                ...
                <div class="w-100">
                    <h2>
                        ...
                        <span>
                            <span>Enhancing Your Visual Storytelling</span>
                    ...
                    <div class="rich-text mt-6 text-lg leading-[1.4] lg:text-[21px]">
                        <p>
                            Video editing is the art of bringing your raw footage to life. Our team of expert editors
                            will help transform your videos into compelling visual stories that captivate audiences. We
                            offer comprehensive video editing services, from basic cuts to advanced effects and
                            transitions.
                        </p>
                        <p>
                            Whether you need an advertisement, promotional video, or vlog, we ensure every project meets
                            high-quality standards, keeping your brand at the forefront.
                        </p>
                    </div>
                </div>
            </article>
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-2">
                <div>
                    <h4>1/ Video Editing and Post-Production:</h4>
                    <ul class="ml-4 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                        <li>
                            Edit raw footage to create a seamless, engaging narrative.
                        </li>
                        <li>
                            Color grading and enhancement to improve the visual quality of the footage.
                        </li>
                        <li>
                            Add transitions, sound effects, background music, and voiceovers.
                        </li>
                    </ul>
                </div>
                <div>
                    <h4>2/ Motion Graphics and Animation:</h4>
                    <ul class="ml-4 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                        <li>
                            Create custom motion graphics for logos, intros, or title sequences.
                        </li>
                        <li>
                            Incorporate animation elements into your video to enhance storytelling.
                        </li>
                        <li>
                            Add dynamic effects, including 3D animations and visual elements.
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="section-space-bottom">
        ...
        <div class="container">
            ...
            <p class="text-lg leading-[1.42] lg:text-[21px]">
                We follow a structured, yet flexible approach to video editing to ensure every project is
                completed to the highest standards. Here’s how we do it:
            </p>
            <div
                    ...
                    <ul class="mt-[50px] flex flex-col gap-y-6">
                        ...
                        <li>
                            ...
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    We begin with a detailed discussion of your project goals, preferred style, and any
                                    special requests.
                                </li>
                                <li>
                                    Understanding your brand and target audience helps guide the editing process to
                        ...
                        <li>
                            <div class="flex gap-x-5">
                                ...
                                <h4 class="flex-1">Video Editing:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    Our editors cut and arrange your footage, ensuring a smooth flow and cohesive
                                    narrative.
                                </li>
                                <li>
                                    We also handle audio editing, syncing sound with visuals and adding background
                                    music.
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <div class="flex gap-x-5">
                                ...
                                <h4 class="flex-1">Post-Production Enhancements:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    Color correction and grading for professional visuals.
                                </li>
                                <li>
                                    Adding visual effects, motion graphics, and any animation needed to elevate the
                                    video’s impact.
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <div class="flex gap-x-5">
                                <img src="assets/img/icons/icon-black-rocket.svg" alt="icon-black-rocket" width="38"
                                    height="44" class="h-10 w-auto" />
                                <h4 class="flex-1">Final Delivery and Review:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    After finalizing the video, we send it for review, incorporating any last-minute
                                    adjustments.
                                </li>
                                <li>
                                    Once approved, we deliver the video in your desired format for distribution across
                                    platforms.
                                </li>
                            </ul>
                        </li>
