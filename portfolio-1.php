            ...
            <ul class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-1.jpg" alt="project-thumbnail-1" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-2.jpg" alt="project-thumbnail-2" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->

                        <!-- Content -->
                        <div class="absolute bottom-0 z-10 flex w-full flex-col items-start justify-between gap-x-7 gap-y-8 p-6 transition-all duration-300 sm:flex-row sm:items-center lg:translate-y-full lg:group-hover:translate-y-0">
                            <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                                <a href="portfolio-details.php" class="mb-[10px] block font-syne text-2xl font-bold leading-[1.4] hover:text-colorLightLime md:text-3xl">Logo and Branding</a>
                                <p class="line-clamp-2">
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-3.jpg" alt="project-thumbnail-3" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-4.jpg" alt="project-thumbnail-4" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-5.jpg" alt="project-thumbnail-5" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-6.jpg" alt="project-thumbnail-6" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->

                        <!-- Content -->
                        <div class="absolute bottom-0 z-10 flex w-full flex-col items-start justify-between gap-x-7 gap-y-8 p-6 transition-all duration-300 sm:flex-row sm:items-center lg:translate-y-full lg:group-hover:translate-y-0">
                            <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                                <a href="portfolio-details.php" class="mb-[10px] block font-syne text-2xl font-bold leading-[1.4] hover:text-colorLightLime md:text-3xl">Environmental Design</a>
                                <p class="line-clamp-2">
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-7.jpg" alt="project-thumbnail-7" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->

                        <!-- Content -->
                        <div class="absolute bottom-0 z-10 flex w-full flex-col items-start justify-between gap-x-7 gap-y-8 p-6 transition-all duration-300 sm:flex-row sm:items-center lg:translate-y-full lg:group-hover:translate-y-0">
                            <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                                <a href="portfolio-details.php" class="mb-[10px] block font-syne text-2xl font-bold leading-[1.4] hover:text-colorLightLime md:text-3xl">Advertising Campaigns</a>
                                <p class="line-clamp-2">
                ...
                <li class="jos">
                    <div class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                        <!-- Thumbnail -->
                        <img src="assets/img/images/th-1/project-thumbnail-8.jpg" alt="project-thumbnail-8" width="626" height="390" class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                        <!-- Thumbnail -->

                        <!-- Content -->
                        <div class="absolute bottom-0 z-10 flex w-full flex-col items-start justify-between gap-x-7 gap-y-8 p-6 transition-all duration-300 sm:flex-row sm:items-center lg:translate-y-full lg:group-hover:translate-y-0">
                            <div class="max-w-[520px] flex-1 text-colorButteryWhite">
                                <a href="portfolio-details.php" class="mb-[10px] block font-syne text-2xl font-bold leading-[1.4] hover:text-colorLightLime md:text-3xl">Website Design & Development</a>
                                <p class="line-clamp-2">
