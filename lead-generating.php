        ...
        <div class="container">
            ...
            <article>
                <div class="mb-20 block overflow-hidden rounded-[35px] border-2 border-black lg:border-[5px]">
                    <img src="assets/img/images/th-1/service-details-img.jpg" alt="service-details-img" width="1286"
                        height="590" class="h-auto w-full object-cover" />
                </div>
                <div class="max-w-[650px] md:mb-[60px] xl:max-w-[856px]">
                    <h2>
                        Lead Generation Services
                        <span>
                            <span>Turning Visitors into Customers</span>
                    ...
                    <div class="rich-text mt-6 text-lg leading-[1.4] lg:text-[21px]">
                        <p>
                            Our Lead Generation services are designed to drive targeted traffic to your business,
                            increase engagement, and convert prospects into loyal customers. Whether you need help with
                            email marketing, SEO, or paid advertising, we have a tailored approach to maximize lead
                            acquisition.
                        </p>
                        <p>
                            We combine innovative strategies with the latest technologies to ensure that your lead
                            generation campaigns are optimized for the highest return on investment (ROI).
                        </p>
                    </div>
                </div>
            </article>
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-2">
                <div>
                    <h4>1/ Targeted Lead Capture:</h4>
                    <ul class="ml-4 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                        <li>
                            Creating lead capture forms that attract potential customers.
                        </li>
                        <li>
                            Using landing pages optimized for high conversion rates.
                        </li>
                        <li>
                            Implementing lead magnets (e.g., free guides, consultations) to encourage sign-ups.
                        </li>
                    </ul>
                </div>
                <div>
                    <h4>2/ Multi-Channel Lead Generation:</h4>
                    <ul class="ml-4 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                        <li>
                            Engaging in email marketing campaigns to nurture leads.
                        </li>
                        <li>
                            Running paid ad campaigns (Google Ads, Facebook Ads) to capture high-quality leads.
                        </li>
                        <li>
                            Utilizing SEO strategies to attract organic leads and drive traffic.
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="section-space-bottom">
        ...
        <div class="container">
            ...
            <p class="text-lg leading-[1.42] lg:text-[21px]">
                Our lead generation process is designed to attract high-quality leads and convert them into
                loyal customers. Here's how we do it:
            </p>
            <div
                    ...
                    <ul class="mt-[50px] flex flex-col gap-y-6">
                        ...
                        <li>
                            ...
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    We conduct research to identify your ideal customer profile and target audience.
                                </li>
                                <li>
                                    We analyze competitor strategies and industry trends to stay ahead of the curve.
                                </li>
                            </ul>
                        </li>
                        <!-- Service Content Item -->
                        <li>
                            <div class="flex gap-x-5">
                                ...
                                <h4 class="flex-1">Lead Magnets & Offers:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    We design attractive offers such as ebooks, whitepapers, or webinars to entice
                                    potential leads.
                                </li>
                                <li>
                                    Engaging calls to action and offers that align with customer pain points and needs.
                                </li>
                            </ul>
                        </li>
                        <!-- Service Content Item -->
                        <li>
                            <div class="flex gap-x-5">
                                ...
                                <h4 class="flex-1">Lead Nurturing & Conversion:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    Once the leads are captured, we use email marketing, retargeting ads, and phone
                                    outreach to nurture the relationship.
                                </li>
                                <li>
                                    We continuously optimize the lead nurturing process to maximize conversions.
                                </li>
                            </ul>
                        </li>
                        <!-- Service Content Item -->
                        <li>
                            <div class="flex gap-x-5">
                                <img src="assets/img/icons/icon-black-rocket.svg" alt="icon-black-rocket" width="38"
                                    height="44" class="h-10 w-auto" />
                                <h4 class="flex-1">Reporting & Analytics:</h4>
                            </div>
                            <ul class="ml-20 mt-4 flex list-outside list-disc flex-col gap-y-[30px]">
                                <li>
                                    We provide detailed reports to measure the effectiveness of your lead generation
                                    campaigns.
                                </li>
                                <li>
                                    We track metrics like conversion rates, cost per lead (CPL), and return on
                                    investment (ROI).
                                </li>
                            </ul>
                        </li>
                ...
                <div class="jos" data-jos_animation="fade-right">
                    <div
                        ...
                        <img src="assets/img/images/th-1/service-details-inner-img.jpg" alt="service-details-inner-img"
                            width="548" height="632" class="h-auto w-full object-cover" />
                    </div>
                </div>
                <!-- Service Content Right Block -->
            </div>
