...
<main class="main-wrapper">
    ...
    <div class="section-blog">
        ...
        <div class="section-space">
            ...
            <div class="container">
                <!-- Blog area -->
                <div class="gapy-10 grid grid-cols-1 gap-x-[60px] gap-y-10 lg:grid-cols-[1fr_minmax(0,360px)] xxl:grid-cols-[1fr_minmax(0,416px)]">
                    <!-- Blog Left Side -->
                    <div>
                        <!-- Blog Post Article -->
                        <article class="jos overflow-hidden">
                            <div class="mb-7 block overflow-hidden rounded-[20px]">
                                <img src="assets/img/images/th-1/blog-img-1.jpg" alt="blog-img-1" width="820" height="500" class="h-auto w-full object-cover" />
                            </div>
                            <!-- Post Meta -->
                        ...
                        <div class="my-10 flex flex-wrap items-center justify-between gap-x-10 gap-y-5 border-y border-[#E6E6E6] py-6">
                            ...
                            <div class="flex items-center gap-x-6">
                                ...
                                <div class="flex gap-4">
                                    <a href="blog-1.php" class="rounded-[50px] bg-black/5 px-6 py-2 text-base tracking-[0.5px] hover:bg-black hover:text-white">Solutions</a>
                                    <a href="blog-1.php" class="rounded-[50px] bg-black/5 px-6 py-2 text-base tracking-[0.5px] hover:bg-black hover:text-white">Business</a>
                                </div>
                            </div>
                            <!-- Blog Details Tags -->
                            <!-- Blog Details Share -->
                            <div class="flex items-center gap-x-6">
                                ...
                                <div class="flex gap-4">
                                    <a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer" class="group/link inline-flex items-center justify-center">
                                    ...
                                    <a href="http://www.facebook.com" target="_blank" rel="noopener noreferrer" class="group/link inline-flex items-center justify-center">
                                    ...
                                    <a href="http://www.instagram.com" target="_blank" rel="noopener noreferrer" class="group/link inline-flex items-center justify-center">
                                    ...
                                    <a href="http://www.linkedin.com" target="_blank" rel="noopener noreferrer" class="group/link inline-flex items-center justify-center">
